...
<html>
    ...
    <link rel="icon" type="image/png" href="images/icon.ico" sizes="16x16">
        <title>Total Tool One-Stop Tool Shop</title>
     ...
     <body>
         ...
         <br>
         <div class="container" style="background-color: rgb(0,113,122);">
             <br>
            <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-8">
                <div class="jumbotron" style="width: 100%;height: 100%">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="card mb-3" style="background-color: rgb(0,113,122);">
                                <p class="card-header">
                        ...
                        <div class="col-sm-4"> 
                          <div class="cardmb-3" style="background-color: rgb(0,113,122);">
                                <p class="card-header">
